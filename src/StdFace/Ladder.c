...
void StdFace_Ladder(struct StdIntList *StdI, char *model)
{
  ...
  if (model == "spin") {
    ...
    StdFace_PrintVal_c("t1", &StdI->t1, _Cbuild(1.0, 0.0));
    StdFace_PrintVal_c("t1'", &StdI->t1p, _Cbuild(1.0, 0.0));
    StdFace_PrintVal_c("t0", &StdI->t0, _Cbuild(1.0, 0.0));
    StdFace_PrintVal_c("t2", &StdI->t2, _Cbuild(1.0, 0.0));
    StdFace_PrintVal_c("t2", &StdI->t2p, _Cbuild(1.0, 0.0));
  ...
  */
  ...
  if (model == "spin")
    ...
    for (isite = 0; isite < StdI->nsite / 2; isite++) {
      ...
      StdI->locspinflag[isite + StdI->L * StdI->W] = 0;
    }
  /*
  ...
  */
  if (model == "spin") {
    ...
    if (model == "kondo") StdI->nintr += StdI->nsite / 2 * (3 * 1 + 1) * (3 * StdI->S2 + 1);
  }
  /**/
  ...
  */
  ...
  for (iL = 0; iL < StdI->L; iL++) {
    for (iW = 0; iW < StdI->W; iW++) {
      ...
      isite = iW + iL * StdI->W;
      if (model == "kondo") isite += StdI->L * StdI->W;
      /*
       Local term
      */
      if (model == "spin") {
      ...
      */
      ...
      if (model == "kondo") jsite += StdI->L * StdI->W;
      /**/
      if (model == "spin") {
      ...
      */
      ...
      if (model == "spin") {
        ...
        StdFace_Hopping(StdI, StdI->t1p, isite, jsite, "hopp");
      ...
      */
      if (iW < StdI->W - 1) {
        ...
        */
        ...
        if (model == "kondo") ksite += StdI->L * StdI->W;
        jsite = iW + ((iL + 1) % StdI->L) * StdI->W;
        if (model == "kondo") jsite += StdI->L * StdI->W;
        if (model == "spin") {
          ...
          StdFace_Hopping(StdI, StdI->t2p, isite, jsite, "hopp");
