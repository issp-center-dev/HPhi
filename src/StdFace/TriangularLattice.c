...
void StdFace_Triangular(struct StdIntList *StdI, char *model)
{
  ...
  */
  if (strcmp(StdI->model, "spin") == 0 ) {
    ...
    StdI->ntrans = StdI->NCell * 2/*spin*/ * (StdI->NsiteUC/*mu*/ + 6/*t*/ + 6/*t'*/);
  ...
  */
  ...
  for (kCell = 0; kCell < StdI->NCell; kCell++) {
    ...
    */
    StdFace_SetLabel(StdI, fp, iW, iL, 1, - 1, 0, 0, &isite, &jsite, 1, &Cphase);
    /**/
    if (strcmp(StdI->model, "spin") == 0 ) {
    ...
    */
    StdFace_SetLabel(StdI, fp, iW, iL, 2, - 1, 0, 0, &isite, &jsite, 2, &Cphase);
    /**/
    if (strcmp(StdI->model, "spin") == 0 ) {
    ...
    */
     ...
     */
    StdFace_SetLabel(StdI, fp, iW, iL, - 1, 2, 0, 0, &isite, &jsite, 2, &Cphase);
    /**/
    if (strcmp(StdI->model, "spin") == 0 ) {
      StdFace_GeneralJ(StdI, StdI->Jp, StdI->S2, StdI->S2, isite, jsite);
    }/*if (strcmp(StdI->model, "spin") == 0 )*/
