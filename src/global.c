...
const char* cFileNameNBodyG_Lanczos="%s_NBodyG.dat";
const char* cFileNameAnomalousG_Lanczos="%s_AnomalousG.dat";
...
const char* cFileNameSS_TPQ_Aggregate="SS_tpq.dat";
const char* cFileNameNorm_TPQ_Aggregate="Norm_tpq.dat";
const char* cFileNameFlct_TPQ_Aggregate="Flct_tpq.dat";
...
const char* cFileNameNBodyG_TPQ="%s_NBodyG_set%dstep%d.dat";
const char* cFileNameAnomalousG_TPQ="%s_AnomalousG_set%dstep%d.dat";
const char* cFileName1BGreen_TPQ_Aggregate="%s_cisajs_tpq.dat";
const char* cFileName2BGreen_TPQ_Aggregate="%s_cisajscktalt_tpq.dat";
const char* cFileName3BGreen_TPQ_Aggregate="%s_ThreeBody_tpq.dat";
const char* cFileName4BGreen_TPQ_Aggregate="%s_FourBody_tpq.dat";
const char* cFileName6BGreen_TPQ_Aggregate="%s_SixBody_tpq.dat";
const char* cFileNameNBodyG_TPQ_Aggregate="%s_NBodyG_tpq.dat";
const char* cFileNameAnomalousG_TPQ_Aggregate="%s_AnomalousG_tpq.dat";
...
const char* cFileNameNBodyG_TE="%s_NBodyG_step%d.dat";
const char* cFileNameAnomalousG_TE="%s_AnomalousG_step%d.dat";
const char* cFileName1BGreen_TE_Aggregate="%s_cisajs_te.dat";
const char* cFileName2BGreen_TE_Aggregate="%s_cisajscktalt_te.dat";
const char* cFileName3BGreen_TE_Aggregate="%s_ThreeBody_te.dat";
const char* cFileName4BGreen_TE_Aggregate="%s_FourBody_te.dat";
const char* cFileName6BGreen_TE_Aggregate="%s_SixBody_te.dat";
const char* cFileNameNBodyG_TE_Aggregate="%s_NBodyG_te.dat";
const char* cFileNameAnomalousG_TE_Aggregate="%s_AnomalousG_te.dat";
...
const char* cFileNameNBodyG_FullDiag="%s_NBodyG_eigen%d.dat";
const char* cFileNameAnomalousG_FullDiag="%s_AnomalousG_eigen%d.dat";
const char* cFileName1BGreen_Eigen_Aggregate="%s_cisajs_eigen.dat";
const char* cFileName2BGreen_Eigen_Aggregate="%s_cisajscktalt_eigen.dat";
const char* cFileName3BGreen_Eigen_Aggregate="%s_ThreeBody_eigen.dat";
const char* cFileName4BGreen_Eigen_Aggregate="%s_FourBody_eigen.dat";
const char* cFileName6BGreen_Eigen_Aggregate="%s_SixBody_eigen.dat";
const char* cFileNameNBodyG_Eigen_Aggregate="%s_NBodyG_eigen.dat";
const char* cFileNameAnomalousG_Eigen_Aggregate="%s_AnomalousG_eigen.dat";
