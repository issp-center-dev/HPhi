...
mkdir -p lobcg_spingc_hcor/
cd lobcg_spingc_hcor
...
EOF
paste output/zvo_ThreeBody_eigen0.dat reference.dat > paste2.dat
...
EOF
paste output/zvo_FourBody_eigen0.dat reference.dat > paste3.dat
