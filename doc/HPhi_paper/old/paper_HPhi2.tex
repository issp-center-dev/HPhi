...
\author[b]{Youhei Yamaji}

\cortext[author] {Corresponding author.\\\textit{E-mail address:} firstAuthor@somewhere.edu}
\address[a]{Second Address}
\address[b]{Quantum-Phase Electronics Center (QPEC), The University of Tokyo, Bunkyo-ku, Tokyo, 113-8656, Japan}
...
{\em Manuscript Title:}                                       \\
{\em Authors:}                                                \\
{\em Program Title: $\mathcal{H}\Phi$}                                          \\
{\em Journal Reference:}                                      \\
  %Leave blank, supplied by Elsevier.
{\em Catalogue identifier:}                                   \\
  %Leave blank, supplied by Elsevier.
{\em Program summary URL: \verb|http://ma.cms-initiative.jp/en/application-list/hphi?set_language=en|}  \\
{\em Licensing provisions: GNU General Public Licence (GPLv3)}                                   \\
  %enter "none" if CPC non-profit use license is sufficient.
{\em Programming language: C}                                   \\
{\em Computer: Any architecture with suitable compilers including PCs and clusters.}                                               \\
  %Computer(s) for which program has been designed.
{\em Operating system: Unix, Linux, OSX.}                                       \\
...
\subsection{Generalized Hamiltonians}
